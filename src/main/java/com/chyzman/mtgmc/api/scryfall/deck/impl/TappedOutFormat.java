...
//
//public class TappedOutFormat extends UriDeckFormat {
//    private static final Logger LOGGER = LogUtils.getLogger();
//
//    private static final Pattern TAPPPEDOUT_URL_PATTERN = Pattern.compile("(?:https?://)?tappedout\\.net/mtg-decks/([^?/]*)");
//
//    @Override
//    public boolean inputValid(URI input) {
//        return TAPPPEDOUT_URL_PATTERN.matcher(input.toString()).matches();
//    }
//
//    @Override
//    public Procrastinator<List<CardIdentifier.ScryfallId>> load(String input) {
//        var matcher = TAPPPEDOUT_URL_PATTERN.matcher(input);
//        if (!matcher.matches()) return Procrastinator.procrastinated(List.of());
//        var deckId = matcher.group(1);
//        var request = HttpRequest
//                .newBuilder()
//                .uri(URI.create("https://tappedout.net/mtg-decks/mtg-decks/" + deckId + "?fmt=multiverse"))
//                .build();
//
