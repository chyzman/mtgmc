...
public abstract class MtgMcBlockEntityRenderer<T extends BlockEntity> implements BlockEntityRenderer<T> {
    ...
    protected MtgMcBlockEntityRenderer(BlockEntityRendererFactory.Context ctx) {
        this.ctx = ctx;
    }
